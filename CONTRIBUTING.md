# Contributing to 4diac FORTE Build Container
...
### What is 4diac FORTE Build Container

4diac FORTE Build Container contains the setup files for build container to efficiently build 4diac FORTE images. 
